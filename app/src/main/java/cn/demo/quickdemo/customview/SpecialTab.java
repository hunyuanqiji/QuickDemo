package cn.demo.quickdemo.customview;
...
public class SpecialTab extends BaseTabItem {
    ...
    public SpecialTab(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIcon = findViewById(R.id.specail_iv);
        mTitle = findViewById(R.id.specail_tv);
        viewPoint = findViewById(R.id.specail_iv_point);
//        mTitle.setTextSize(PixelUtil.px2sp(getResources().getDimension(R.dimen.item_textSize_20px),getContext()));
...
//        mMessages.setHasMessage(hasMessage);
        viewPoint.setVisibility(hasMessage?VISIBLE:GONE);
    }
