...
final class CalendarViewDelegate {
     ...
     * 标记的开放预约量为0
     */
    Map<String, Calendar> zeroSchemeDatesMap;
    /**
     * 日期被选中监听
     */
...
//        mCurDayLunarTextColor = array.getColor(R.styleable.CalendarView_current_day_lunar_text_color, Color.RED);
        mCurDayTextColor = array.getColor(R.styleable.CalendarView_current_day_text_color, 0xFF333333);
        mCurDayLunarTextColor = array.getColor(R.styleable.CalendarView_current_day_lunar_text_color, 0xffe1e1e1);
...
//        mCalendarItemHeight = (int) array.getDimension(R.styleable.CalendarView_calendar_height, CalendarUtil.dipToPx(context, 56));
        mCalendarItemHeight = (int) array.getDimension(R.styleable.CalendarView_calendar_height, CalendarUtil.dipToPx(context, 41));
    ...
    void setSelectColor(int selectedColor){
        this.mSelectedThemeColor = selectedColor;
    }
