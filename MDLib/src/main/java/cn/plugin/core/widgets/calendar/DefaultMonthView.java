...
public final class DefaultMonthView extends MonthView {
     ...
     */
    @Override
    protected boolean onDrawSelected(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, int selectShemeColor) {
        mSelectedPaint.setStyle(Paint.Style.FILL);
        this.mSelectedPaint.setColor(selectShemeColor);
