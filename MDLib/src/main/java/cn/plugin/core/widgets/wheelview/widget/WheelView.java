package cn.plugin.core.widgets.wheelview.widget;
...
import cn.plugin.core.widgets.wheelview.entity.WheelItem;
import cn.plugin.core.widgets.wheelview.util.ConvertUtils;
import cn.plugin.core.widgets.wheelview.util.LogUtils;
...
//    public static final float LINE_SPACE_MULTIPLIER = 2.5F;
    public static final float LINE_SPACE_MULTIPLIER = 1.0F;
...
//    public static final int DIVIDER_ALPHA = 220;
    public static final int DIVIDER_ALPHA = 255;
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        focus_height = array.getDimensionPixelSize(R.styleable.WheelView_focus_height, dp2px(100));
...
//            Log.e("TAG", "onDraw: "+(secondLineY-firstLineY) );
//            canvas.drawRect(measuredWidth * ratio,firstLineY, measuredWidth * (1 - ratio),secondLineY,paintIndicator);
//            canvas.drawRect(measuredWidth * ratio,firstLineY, measuredWidth ,secondLineY,paintIndicator);
            float between = (secondLineY-firstLineY)/2.0F;
//            canvas.drawRect(0.0F,firstLineY, measuredWidth ,secondLineY,paintIndicator);
//            firstLineY = dividerConfig.dividerTop;
//            canvas.drawRect(0.0F,firstLineY+between-(focus_height)/2.0F+0.25f, measuredWidth ,firstLineY+between+(focus_height)/2.0F+0.25f,paintIndicator);
//            canvas.drawRect(0.0F, firstLineY, widthAll, secondLineY, paintIndicator);
        }
...
//                    canvas.drawRect(0.0F, firstLineY, Y, secondLineY, paintIndicator);
                    canvas.drawText(contentText, drawCenterContentStart, Y+0.5f, paintCenterText);
                } else {
                    // 其他条目
                    canvas.save();
...
//        measuredHeight = getDefaultSize(getSuggestedMinimumHeight(), heightMeasureSpec);
    ...
    public static class DividerConfig {
        ...
        public void setDividerTop(float dividerTop) {
