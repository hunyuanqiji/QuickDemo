...
/**
 * Created by Yang_Yang on 2018/10/17 0017
 */
public class UperRefreshFooter extends LinearLayout implements RefreshFooter {
    ...
    public UperRefreshFooter(Context context) {
        super(context);
        this.initView(context, null, 0);
    }

    public UperRefreshFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs, 0);
    }

    public UperRefreshFooter(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public UperRefreshFooter setSpinnerStyle(SpinnerStyle style) {
