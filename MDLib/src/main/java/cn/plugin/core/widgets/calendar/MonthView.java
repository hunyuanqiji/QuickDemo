...
public abstract class MonthView extends BaseView {
    ...
    private void draw(Canvas canvas, Calendar calendar, int i, int j, int d) {
        ...
        if (hasScheme) {
            ...
            if (isSelected) {
                isDrawSelected = onDrawSelected(canvas, calendar, x, y, true,mDelegate.getSelectedThemeColor());
            }
            ...
            if (isSelected) {
                onDrawSelected(canvas, calendar, x, y, false,mDelegate.getSelectedThemeColor());
            }
        }
     ...
     */
    protected abstract boolean onDrawSelected(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, int selectShemeColor);
