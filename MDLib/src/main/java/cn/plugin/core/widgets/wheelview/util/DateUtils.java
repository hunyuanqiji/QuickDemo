package cn.plugin.core.widgets.wheelview.util;
...
import cn.plugin.core.widgets.calendar.CalendarView;
...
public class DateUtils extends android.text.format.DateUtils {
    ...
    public static final int MORNING = 1;//预约改签变量10：30以前
    public static final int NOON = 2;//预约改签变量10：30与15：00中间
    public static final int AFTERNOON = 3;//预约改签变量15：00以后
    public static final int RESERVATION = 1;
    public static final int NORESERVATION = 0;
    ...
    public static void setCalendarView(final TextView mTVDate, CalendarView mCalendarView) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy年M月");
        mTVDate.setText(dateFormat.format(new Date(System.currentTimeMillis())));

//        mCalendarView.getmMonthPager().setDateChangePageListener(new OnDateChangePageListener() {
//            @Override
//            public void onDateChangePage(cn.mdruby.doctork.ui.reservation.view.calendar.Calendar calendar) {
//                mTVDate.setText(calendar.getYear() + "年" + calendar.getMonth() + "月");
//            }
//        });
//
//        mCalendarView.getmWeekPager().setDateChangePageListener(new OnDateChangePageListener() {
//            @Override
//            public void onDateChangePage(cn.mdruby.doctork.ui.reservation.view.calendar.Calendar calendar) {
//                mTVDate.setText(calendar.getYear() + "年" + calendar.getMonth() + "月");
//            }
//        });
    ...
    public static String canlendarString(cn.plugin.core.widgets.calendar.Calendar calendar) {
        return calendar.getYear() + "-" + (calendar.getMonth() < 10 ? "0" + calendar.getMonth() : calendar.getMonth() + "") + "-" + (calendar.getDay() < 10 ? "0" + calendar.getDay() : "" + calendar.getDay());
    }

    /**
     * 添加日期  格式 年-月
     */
    public static String canlendarMonthString(cn.plugin.core.widgets.calendar.Calendar calendar) {
        return calendar.getYear() + "-" + (calendar.getMonth() < 10 ? "0" + calendar.getMonth() : calendar.getMonth() + "");
    }

    /**
     * 添加预约时候判断上午的预约时间
     */
    public static boolean isForenoonReservation() {

        Calendar cal = Calendar.getInstance();// 当前日期
        int hour = cal.get(Calendar.HOUR_OF_DAY);// 获取小时
        int minute = cal.get(Calendar.MINUTE);// 获取分钟
        int minuteOfDay = hour * 60 + minute;// 从0:00分开是到目前为止的分钟数
        final int start = 10 * 60 + 30;// 起始时间 10:30的分钟数
        final int end = 15 * 60;// 结束时间 15:00的分钟数
        return minuteOfDay <= start;
    }

    public static boolean isAfternoonReservation() {
    ...
    /**
     * 判断预约时间在10:30与15:00的哪个时刻
     */
    public static int isReservationDate() {
