...
/**
 * Created by Went_Gone on 2017/3/8.
 */
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param drawableId  分割线图片
     */
    public DividerItemDecoration(Context context, int orientation, int drawableId, int paddingLeft, int paddingRight) {
        this.setOrientation(orientation);
        //旧的getDrawable方法弃用了，这个是新的
        mDrawable = ContextCompat.getDrawable(context, drawableId);
        mDividerHeight = mDrawable.getIntrinsicHeight();
...
//                    outRect.right = paddingRight;
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        final int x1 = parent.getPaddingLeft();
        final int width1 = parent.getMeasuredWidth() - parent.getPaddingRight();
        final int x = x1+paddingLeft;
        final int width = width1-paddingRight;
